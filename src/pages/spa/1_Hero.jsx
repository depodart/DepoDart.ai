  ...
  return (
    <section className={heroStyles.section} aria-label="Hero">
      <div className={heroStyles.contentWrapper}>
        <motion.div
          style={{ y, opacity }}
          className={`${heroStyles.mainContainer} ${defaultSectionStyles.paddingX}`}
        >
          ...
          <div className="max-w-2xl">
            ...
            <motion.p
              ...
              className="mt-6 text-[15px] sm:text-[18px] text-primary-light/70 leading-relaxed"
            >
      ...
      {/* The 3D globe — primary spatial moment */}
