      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        >
          ...
          <p className="text-2xl text-primary-light/80 max-w-3xl mx-auto leading-relaxed">
            Revolutionizing terrain analysis through cutting-edge AI and advanced visualization technologies
          </p>
        </motion.div>
        ...
        >
          {technologies.map((tech, index) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-r ${tech.gradient} rounded-2xl opacity-20 group-hover:opacity-30 transition-opacity duration-300`}></div>
        ...
        >
          <Link to="/contact" className="inline-block bg-gradient-to-r from-secondary-dark to-tertiary-light text-primary-light px-10 py-4 rounded-full text-lg font-semibold hover:shadow-lg hover:shadow-secondary-dark/30 transition-all duration-300 hover:scale-105">
