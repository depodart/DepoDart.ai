      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-primary-light/80 max-w-2xl mx-auto">
            Explore our collection of articles, guides, and insights about
            terrain analysis, environmental monitoring, and sustainable
            development.
          </p>
        </div>
        ...
        >
          {articles.map((article, index) => (
            ...
            >
              ...
              <p className="text-primary-light/70">{article.description}</p>
              <div className="mt-4">
                <a
                  href={article.pdfUrl}
                  target="_blank"
