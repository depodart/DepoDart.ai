...
export const colors = {
    ...
    lightText: "#dfd9ff",
    navyBlue: "#1d1836",
    navyBlueBorder: "#232631",
    royalBlue: "#4F46E5", // indigo-600
    brightBlue: "#6366F1", // indigo-500
    hotPink: "#EC4899", // pink-400
    lavender: "#A855F7", // purple-400
};
...
export const navbarStyles = {
  nav: `w-full flex items-center py-5 fixed top-0 z-20 bg-gradient-to-b from-[${colors.darkBackground}] via-[${colors.darkBackground}] to-transparent backdrop-blur-md`,
  container: "w-full flex justify-between items-center max-w-7xl mx-auto",
  logo: "flex items-center gap-2",
  logoText: `text-${colors.pureWhite} text-[20px] font-bold cursor-pointer flex`,
  ...
  activeLink: `text-${colors.pureWhite}`,
  inactiveDesktopLink: `text-${colors.pureWhite}`,
  ...
  mobileMenuDropdown: `p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl bg-[${colors.brightPurple}]`
};
...
export const heroStyles = {
  ...
  leftDecoration: {
    ...
    circle: `w-5 h-5 rounded-full bg-[${colors.brightPurple}]`,
    line: "w-1 sm:h-80 h-40 violet-gradient"
  },
  textContent: {
    brandHighlight: `text-[${colors.brightPurple}]`,
  ...
  heroHeadText: `text-${colors.pureWhite}`,
};
...
export const experienceStyles = {
    ...
    timelineElementArrow: {
      borderRight: `7px solid ${colors.navyBlueBorder}`
    },
    iconContainer: "flex justify-center items-center w-full h-full",
    iconImage: "w-[60%] h-[60%] object-contain",
    cardTitle: `text-${colors.pureWhite} text-[24px] font-bold`,
    cardSubtitle: {
      margin: 0,
...
export const worksStyles = {
  projectCard: {
    ...
    title: `text-${colors.pureWhite} font-bold text-[24px]`,
...
export const contactStyles = {
    formInput: `block w-full rounded-md bg-${colors.pureWhite} px-3.5 py-2 text-base text-gray-900 placeholder:text-gray-400`,
    formLabel: `block text-sm font-semibold text-${colors.pureWhite}`,
    ...
    backgroundGradientElement: `relative left-1/2 aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-${colors.hotPink} to-${colors.lavender} opacity-30 sm:w-[72.1875rem]`,
    ...
    submitButton: `block w-full rounded-md bg-${colors.royalBlue} px-3.5 py-2.5 text-center text-sm font-semibold text-${colors.pureWhite} shadow-sm hover:bg-${colors.brightBlue} disabled:opacity-50`,
  ...
  export const styles = {
    ...
    heroHeadText:
      `font-black text-${colors.pureWhite} lg:text-[80px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2`,
    heroSubText:
      `text-${colors.lightText} font-medium lg:text-[30px] sm:text-[26px] xs:text-[20px] text-[16px] lg:leading-[40px]`,
  
    sectionHeadText:
      `text-${colors.pureWhite} font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px]`,
    sectionSubText:
